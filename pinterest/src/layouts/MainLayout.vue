<template>
  <v-app>
    ...
    <v-navigation-drawer app permanent>
      ...
      <div class="mx-4 subtitle-2 grey--text">Otros</div>
      <v-list dense nav>
        <v-list-item link>
          <v-list-item-icon>
          ...
          <v-list-item-content>
            <v-list-item-title> Mensages </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item link>
          <v-list-item-icon>
      ...
      <v-layout align-center class="my-8 mx-4">
        <v-card style="border-radius: 10px" class="mx-auto" elevation="2">
          <v-list-item>
            <v-list-item-avatar>
              <v-img
                src="https://images.unsplash.com/photo-1499557354967-2b2d8910bcca?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MjZ8fHByb2ZpbGUlMjBpbWFnZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
              />
            </v-list-item-avatar>
            <v-list-item-content>
  ...
  data() {
    return {
      items: [
        ...
        { title: "Recientes", icon: "mdi-clock-time-three" },
        { title: "Seguidores", icon: "mdi-account-group" },
      ],
      items2: [
        { title: "Mensages", icon: "mdi-view-dashboard" },
        { title: "Notificaciones", icon: "mdi-image" },
      ],
    };
  },
};
